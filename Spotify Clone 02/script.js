...
let songs = [
    { songName: "Guli Mata", filePath: "./Guli Mata - Saad Lamjarred _ Shreya Ghoshal _ Jennifer Winget _ Anshul Garg.mp4", coverPath: "cheque.jpg" },
    ...
    { songName: "Zihaal e Miskin", filePath: "./Zihaal e Miskin (Video) Javed-Mohsin _ Vishal Mishra, Shreya Ghoshal _ Rohit Z, Nimrit A _ Kunaal V.mp4", coverPath: "showstopper.jpg" },
    { songName: "Elevated", filePath: "Shubh - Elevated (Official Music Video).mp4", coverPath: "elevated.jpg" },
    { songName: "Dilawara", filePath: "./Dilawara _ The PropheC _ Ezu _ Official Video _ Latest Punjabi Song.mp4", coverPath: "idgaf.jpg" },
    ...
    { songName: "Tere Hawaale", filePath: "./Tere Hawaale (Full Video) Laal Singh Chaddha _ Aamir,Kareena _ Arijit,Shilpa _ Pritam,Amitabh,Advait (1).mp4", coverPath: "12-Saal-Baarah-Saal-English-2011-500x500.jpg" },
